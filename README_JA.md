...
このリポジトリでは、現在 ibet コンソーシアムで提供している各環境のネットワーク定義、ibet-Coreノードコンテナ定義、および運用・検証用ツールを管理しています。
...
- ノードクライアント: [BoostryJP/ibet-Core](https://github.com/BoostryJP/ibet-Core)
...
- ibet-Core ノードクライアントのバージョンアップは 6 か月に 1 回行い、採用バージョンはコンソーシアムの合意により決定します。
